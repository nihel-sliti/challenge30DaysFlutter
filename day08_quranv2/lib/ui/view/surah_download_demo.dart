...
/// 🔥 **ÉCRAN DE DÉMONSTRATION** - Téléchargement et lecture de sourates
/// Montre comment utiliser le service de téléchargement avec audioplayers
class SurahDownloadDemo extends StatefulWidget {
  const SurahDownloadDemo({super.key});

  @override
  State<SurahDownloadDemo> createState() => _SurahDownloadDemoState();
}

class _SurahDownloadDemoState extends State<SurahDownloadDemo> {
    ...
    try {
      ...
      if (file != null) {
        ...
        setState(() {
          ...
          _statusMessage = '✅ Téléchargement terminé (${_downloadService.formatSize(fileSize)})';
        });

        // Auto-play après téléchargement (optionnel)
        // await _playLocalAudio(file.path);
      } else {
        setState(() {
          _isDownloading = false;
  ...
  /// Construit la barre de progression personnalisée
            ...
            Card(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    Icon(
                      _isDownloading ? Icons.download : _isPlaying ? Icons.volume_up : Icons.cloud_download,
                      size: 48,
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ..._popularSurahs.map((surah) {
                      final isDownloaded = _currentFilePath != null && 
                          _currentFilePath!.contains('surah_${surah['number']}.mp3');
